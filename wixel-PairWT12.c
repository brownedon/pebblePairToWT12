////////////////////////////////////////////////////////////////////////////////
//
// Use this on a Polulu Programmable USB Wireless Module
// (https://www.pololu.com/product/1337), to pair a WT12 bluetooth module to
// a Pebble Time Watch.
//
// This program is from an existing Polulu Wixel program: wireless_serial.c - 
// Only lines changed were to set baud rate to 115200, and serial mode to 3
//
// Wixel Pinout:
// P1_6 -- TX UART from WT12
// P1_7 -- RX UART to WT12
// USB port -- serial communication to/from computer (using terminal emulator, like Putty)
// 3.3V -- To WT12 3V3
// GND -- To WT12 GND
// 
// STEPS to pair WT12 to Pebble Time:
// 0 - Unplug battery to Wixel and power it from your computer, using the USB port
// 1 - Complile this file, and upload it onto the Wixel using the Polulu Wixel Config tool 
// 2 - On computer, open a terminal program (PUTTY)and connect your wixel
// (serial, baud=115200, databits=8, 1 stopbit, no parity, HW flow control
// enabled)
// 3 - Put Pebble Time watch close range of the Wixel/WT12, in: Settings->
// Bluetooth (and not currently paired/connected to the WT12)
// 4 - Make sure that WT12 is in Command Mode (not connected or paired)
// ENTER following BT commands:
// SET RESET
// SET BT PAIR *
// SET BT AUTH * 0000
// SET BT SSP 3 0
...
// CALL xx:xx:xx:xx:xx:xx 1101 RFCOMM (ENTER YOUR BT ADDRESS)
// 5 - Open Wixel tool Config again and upload the dexwatch back onto the wixel
// 
////////////////////////////////////////////////////////////////////////////////
...
int32 CODE param_serial_mode = SERIAL_MODE_USB_UART; //CHANGED orig wixel program

// int32 CODE param_baud_rate = 9600;
int32 CODE param_baud_rate = 115200;   //CHANGED orig wixel program
